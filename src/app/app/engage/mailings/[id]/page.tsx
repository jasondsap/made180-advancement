...
export default async function MailingPage({
  ...
  return (
    <div>
      ...
      <a href={`/api/engage/mailings/${message.id}/pdf`} style={{ display: "inline-block", padding: ".6rem 1.2rem", borderRadius: 8, background: "var(--brand)", color: "#fff", textDecoration: "none", fontWeight: 600 }}>
...
function Back() {
  return <p style={{ marginBottom: ".5rem" }}><Link href="/app/engage/mailings" style={{ color: "var(--brand)", fontSize: ".88rem" }}>← Mailings</Link></p>;
}
